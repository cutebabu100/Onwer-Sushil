...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "good night") || (event.body.toLowerCase() == "gn")) {
   ...
   if ((event.body.toLowerCase() == "assalam u alaikum") || (event.body.toLowerCase() == "assalam o laikum")) {
     return api.sendMessage("❤️ Radhe Radhe Ram Ram 🥰", threadID);
   };


   if ((event.body.toLowerCase() == "𝐔𝐌𝐀") || (event.body.toLowerCase() == "𝐂𝐇𝐔𝐌𝐀")) {
     return api.sendMessage("uper kya hai be 🙄😈", threadID);
   };


   if ((event.body.toLowerCase() == "𝐁𝐀𝐁𝐔") || (event.body.toLowerCase() == "𝐁𝐀𝐁𝐘")) {
     return api.sendMessage("Ye nakhre kahi Or Jake Dikha Be 😈", threadID);
   };


   if ((event.body.toLowerCase() == "radhe krishna") || (event.body.toLowerCase() == "radhe radhe")) {
     return api.sendMessage("𝐉𝐀𝐈 𝐒𝐇𝐑𝐈 𝐊𝐑𝐈𝐒𝐇𝐍𝐀💝𝐑𝐀𝐃𝐇𝐄 𝐑𝐀𝐃𝐇𝐄 𝐃𝐄𝐀𝐑 ❤️ ", threadID);
   };
   mess = "{name}"

  if (event.body.indexOf("Sayri") == 0 || (event.body.indexOf("Shayri") == 0)) {
    var msg = {
      body: `🍀🍒${name}🍒🍀,
