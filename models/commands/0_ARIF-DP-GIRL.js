...
"https://i.imgur.com/PqD8g7j.jpeg",
  ...
  var callback = () => api.sendMessage({ body: `👉❤️𝐌𝐚𝐝𝐞 𝐛𝐲 𝐌𝐫.𝐏𝐫𝐢𝐧𝐜𝐞💙✨️`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
